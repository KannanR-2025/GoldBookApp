...
class MetalReceiptEntryScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<MetalReceiptEntryScreen> createState() => _MetalReceiptEntryScreenState();
}

class _MetalReceiptEntryScreenState extends ConsumerState<MetalReceiptEntryScreen>
    ...
    if (_formKey.currentState!.validate() && _selectedPartyId != null) {
      ...
      if (mounted) {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(const SnackBar(content: Text('MetalReceipt Saved')));
        context.pop();
      }
    } else {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(widget.transactionId != null ? 'Edit MetalReceipt' : 'New MetalReceipt'),
        elevation: 0,
      ),
      body: _isLoading
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            ElevatedButton(
                              onPressed: _save,
                              child: const Text('Save MetalReceipt'),
                            ),
                          ],
                        ),
                      ),
