...
#ifndef GOLDBOOK_DESKTOP_SWIFT_H
#define GOLDBOOK_DESKTOP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="goldbook_desktop",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC16goldbook_desktop11AppDelegate")
...
SWIFT_CLASS("_TtC16goldbook_desktop17MainFlutterWindow")
